...
function AnalysisTimeToday() {
  ...
  useEffect(() => {
    axios.get(`${API_URL}/timeweek?selectedOption=${selectedOption}`,{withCredentials:true})
      .then((res) => {
  ...
  return (
    <div className='w-full h-screen border'>
      ...
      <div className='mx-2 flex justify-end xl:mr-16'>
        <select className='border-2 rounded-xl px-2 py-2 text-sm' id="dropdown" value={selectedOption} onChange={handleChangeDrop}>
