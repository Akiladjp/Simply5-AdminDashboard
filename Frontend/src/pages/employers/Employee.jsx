...
function Employee() {
    ...
    useEffect(() => {
        axios.get('http://localhost:8081/employeecard/')
            .then(res => {
    ...
    return (
        <div className="flex flex-wrap items-center justify-center mt-16 ml-16 mr-12 lg:ml-10">
            <div className="grid grid-cols-2 gap-8 mx-auto lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-6">
