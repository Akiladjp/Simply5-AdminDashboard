...
function ItemsMeals() {
  ...
  return (
    <div className='flex flex-wrap items-center justify-start gap-8 mt-16 ml-12 mr-12 lg:ml-10 xl:ml-12 lg:mr-8 xl:mr-4'>
      ...
      <div className=''>
      <Link to="/app/items/add/:Meals" state={{ category: "Meals" }}><button className="flex flex-col items-center justify-center h-[337px] w-[237px] bg-[rgb(0,127,168,0.15)] border-2 rounded-lg border-dashed border-[#027297] hover:bg-[rgb(0,127,168,0.25)]">
