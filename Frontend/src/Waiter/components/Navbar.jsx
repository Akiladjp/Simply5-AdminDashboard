			...
			<div className="flex w-full h-full">
				<ul className="flex w-full h-full">
					{Menus.map((menu, i) => (
						<li
							key={i}
							className={`flex flex-col items-center justify-center w-1/4 hover:bg-[#056A8B] duration-100 ${
								i === active && "bg-white hover:bg-white "
							}`}>
							<Link
								to={menu.path}
								...
								<span
									className={`text-[33px] md:text-5xl md:mt-6 mt-4 cursor-pointer duration-500 ${
										i === active && "text-[#007FA8]"
									}`}>
									{menu.icon}
								</span>
							</Link>
